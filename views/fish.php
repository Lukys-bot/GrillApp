    ...
    <main class="container">
        <div class="nav">
            <ul>
                ...
                <li><a id="thisPage" href="/Projekty/Grill/views/fish.php">Ryby</a>  </li>
        ...
        <div class="mainRecipes">
            <a class="recipes" href="recipe1.php">Grilovaný pstruh</a>
            <a class="recipes" href="recipe2.php">Grilovaný kapr</a>
        </div>    
    </main>
        <div class="pages">
