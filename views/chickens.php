...
<?php include __DIR__."/partials/title_Grill.php"; ?>
    ...
    <main class="container">
        <div class="nav">
            <ul>
                <li><a id="thisPage" href="/Projekty/Grill/views/chickens.php">Kuřecí</a> </li>
        ...
        <div class="mainRecipes">
            <a class="recipes" href="GrilovaneKure.php">Grilované kuře</a>
            <a class="recipes" href="GrilledWings.php">Grilovaná křidýlka</a>
