    ...
    <main class="container">
        <div class="nav">
            <ul>
                ...
                <li><a id="thisPage"  href="/Projekty/Grill/views/smoked.php">Uzení</a>  </li> 
                <li><a href="/Projekty/Grill/views/burgers.php">Burgery</a>  </li> 
                </ul>
            <div class="clearfix"></div>
        </div>
        <div class="mainRecipes">
            <a class="recipes" href="recipe1.php">Domácí uzený bůček</a>
            <a class="recipes" href="recipe2.php">Udíme vepřové</a>
            <a class="recipes" href="recipe3.php">Udíme ryby</a>
        </div>
    </main>
        <div class="pages">
